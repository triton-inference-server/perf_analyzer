...
@total_ordering
class RetiredPagesDBEBase(DecreasingGPURecord):
    """
    A base class for the Total ECC Single Bit Error (DBE) Retired Pages metric.
    """

    base_tag = "retired_pages_dbe"
    ...
    def __lt__(self, other: "RetiredPagesDBEBase") -> bool:
        return other.value() < self.value()

    def __add__(self, other: "RetiredPagesDBEBase") -> "RetiredPagesDBEBase":
        return self.__class__(device_uuid=None, value=(self.value() + other.value()))

    def __sub__(self, other: "RetiredPagesDBEBase") -> "RetiredPagesDBEBase":
