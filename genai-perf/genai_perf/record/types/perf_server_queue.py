...
@total_ordering
class PerfServerQueue(DecreasingRecord):
    """
    A record for Server queue time
    from the perf analyzer
    """

    tag = "perf_server_queue"
    ...
    def __add__(self, other):
        ...
        return PerfServerQueue(value=(self.value() + other.value()))
    ...
    def __sub__(self, other):
        ...
        ** Note this does reverse subtraction because
        ...
        return PerfServerQueue(value=(other.value() - self.value()))
