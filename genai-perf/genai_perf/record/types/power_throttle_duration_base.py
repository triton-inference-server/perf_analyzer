...
@total_ordering
class PowerThrottleDurationBase(DecreasingGPURecord):
    """
    A base class for the Power Throttle Duration metric
    """

    base_tag = "power_throttle_duration"
    ...
    def __lt__(self, other: "PowerThrottleDurationBase") -> bool:
        return other.value() < self.value()

    def __add__(
        self, other: "PowerThrottleDurationBase"
