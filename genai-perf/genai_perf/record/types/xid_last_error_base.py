...
@total_ordering
class XidLastErrorBase(DecreasingGPURecord):
    """
    A base class for the Xid Last Error metric
    """

    base_tag = "xid_last_error"
    ...
    def __lt__(self, other: "XidLastErrorBase") -> bool:
        return other.value() < self.value()

    def __add__(self, other: "XidLastErrorBase") -> "XidLastErrorBase":
        return self.__class__(device_uuid=None, value=(self.value() + other.value()))

    def __sub__(self, other: "XidLastErrorBase") -> "XidLastErrorBase":
