...
@total_ordering
class ECCDBEAggregateTotalBase(DecreasingGPURecord):
    """
    A base class for the ECC Double Bit Error Aggregate Total metric
    """

    base_tag = "total_ecc_dbe_aggregate"
    ...
    def __lt__(self, other: "ECCDBEAggregateTotalBase") -> bool:
        return other.value() < self.value()

    def __add__(self, other: "ECCDBEAggregateTotalBase") -> "ECCDBEAggregateTotalBase":
        return self.__class__(device_uuid=None, value=(self.value() + other.value()))

    def __sub__(self, other: "ECCDBEAggregateTotalBase") -> "ECCDBEAggregateTotalBase":
