...
@total_ordering
class ECCDBEVolatileTotalBase(DecreasingGPURecord):
    """
    A base class for the ECC Double Bit Error Volatile Total metric
    """

    base_tag = "total_ecc_dbe_volatile"
    ...
    def __lt__(self, other: "ECCDBEVolatileTotalBase") -> bool:
        return other.value() < self.value()

    def __add__(self, other: "ECCDBEVolatileTotalBase") -> "ECCDBEVolatileTotalBase":
        return self.__class__(device_uuid=None, value=(self.value() + other.value()))

    def __sub__(self, other: "ECCDBEVolatileTotalBase") -> "ECCDBEVolatileTotalBase":
