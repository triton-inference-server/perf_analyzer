...
@total_ordering
class ThermalThrottleDurationBase(DecreasingGPURecord):
    """
    A base class for the Thermal Throttle Duration metric
    """

    base_tag = "thermal_throttle_duration"
    ...
    def __lt__(self, other: "ThermalThrottleDurationBase") -> bool:
        return other.value() < self.value()

    def __add__(
        self, other: "ThermalThrottleDurationBase"
