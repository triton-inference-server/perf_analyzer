...
class PerfServerComputeOutput(DecreasingRecord):
    ...
    tag = "perf_server_compute_output"
    ...
    def header(aggregation_tag=False):
        ...
        return "Server Compute Output time (ms)"
    ...
    def __add__(self, other):
        ...
        return PerfServerComputeOutput(value=(self.value() + other.value()))
    ...
    def __sub__(self, other):
        ...
        ** Note this does reverse subtraction because
        ...
        return PerfServerComputeOutput(value=(other.value() - self.value()))
