...
@total_ordering
class OutputTokenThroughputPerRequestP1(OutputTokenThroughputPerRequestBase):
    """
    A record for p1 Output token throughput per request metric
    """

    tag = OutputTokenThroughputPerRequestBase.base_tag + "_p1"
