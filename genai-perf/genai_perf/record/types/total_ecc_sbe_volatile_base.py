...
@total_ordering
class ECCSBEVolatileTotalBase(DecreasingGPURecord):
    """
    A base class for the ECC Single Bit Error Volatile Total metric
    """

    base_tag = "total_ecc_sbe_volatile"
    ...
    def __lt__(self, other: "ECCSBEVolatileTotalBase") -> bool:
        return other.value() < self.value()

    def __add__(self, other: "ECCSBEVolatileTotalBase") -> "ECCSBEVolatileTotalBase":
        return self.__class__(device_uuid=None, value=(self.value() + other.value()))

    def __sub__(self, other: "ECCSBEVolatileTotalBase") -> "ECCSBEVolatileTotalBase":
