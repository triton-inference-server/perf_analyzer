...
@total_ordering
class TotalNVLinkCCRCFlitErrorsBase(DecreasingGPURecord):
    """
    A base class for the Total NVLink CRC flow-control errors metric.
    """

    base_tag = "total_nvlink_crc_flit_errors"
    ...
    def __lt__(self, other: "TotalNVLinkCCRCFlitErrorsBase") -> bool:
        return other.value() < self.value()

    def __add__(
        self, other: "TotalNVLinkCCRCFlitErrorsBase"
