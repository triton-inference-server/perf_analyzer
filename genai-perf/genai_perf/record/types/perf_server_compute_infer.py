...
@total_ordering
class PerfServerComputeInfer(DecreasingRecord):
    """
    A record for Server compute infer time
    from the perf analyzer
    """

    tag = "perf_server_compute_infer"
    ...
    def header(aggregation_tag=False):
        ...
        return "Server Compute Infer time (ms)"
    ...
    def __add__(self, other):
        ...
        return PerfServerComputeInfer(value=(self.value() + other.value()))
    ...
    def __sub__(self, other):
        ...
        ** Note this does reverse subtraction because
        ...
        return PerfServerComputeInfer(value=(other.value() - self.value()))
